...
/*Originally copyed from https://github.com/lair-framework/go-nessus on 05/07/2017*/
...
// Parse takes deserializes nessus xml data from the given input and unmarshals it into an
// NessusData struct.
