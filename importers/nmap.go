...
/*
This was originally copyed from https://github.com/lair-framework/go-nmap on 05/07/2017.
*/
...
// Parse takes deserializes nmap xml data from the given input and unmarshals it into an
// NmapRun struct.
